...
(function(/*! Stitch !*/) {
...
}).call(this)({"controllers/main_controller": function(exports, require, module) {(function() {
  ...
  var HomeView, MainController, User, UserMenu;
  window.app = {};
  app.controllers = {};
  app.models = {};
  app.collections = {};
  ...
  $(document).ready(function() {
    app.initialize = function() {
      ...
      if (!(pw.length > 0)) {
        ...
        return app.views.home = new HomeView();
      } else {
        return $('#login_form').trigger("submit");
      }
    };
    app.initialize();
  ...
  exports.User = (function() {
    ...
    User.prototype.log_in = function() {
      return setTimeout(__bind(function() {
        return this.trigger("logged_in");
      }, this), 1500);
    };
    return User;
  })();
  ...
  exports.HomeView = (function() {
    ...
    HomeView.prototype.render = function() {
      $('#main_content').html(this.template());
      return this.after_render();
    };
    HomeView.prototype.after_render = function() {
      return $('#home_content').delay(10).fadeIn();
    };
    HomeView.prototype.finish_view = function() {};
    return HomeView;
  })();
}).call(this);
}, "views/home/login": function(exports, require, module) {(function() {
  ...
  exports.LoginView = (function() {
    ...
    LoginView.prototype.after_render = function() {
      return console.log($('#home_login_submit').length);
    };
    LoginView.prototype.finish_view = function() {
      this.$('.loading').remove();
      this.$('#home_login_submit').show();
...
}, "views/shared/user_menu": function(exports, require, module) {(function() {
  var __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; }, __hasProp = Object.prototype.hasOwnProperty, __extends = function(child, parent) {
    for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; }
    function ctor() { this.constructor = child; }
    ctor.prototype = parent.prototype;
  ...
  exports.UserMenu = (function() {
    ...
    UserMenu.prototype.initialize = function() {
      ...
      app.current_user.bind("logged_out", this.finish_view);
      this.el = $('#user_menu');
      return $('#login_form').submit(function() {
    ...
    UserMenu.prototype.show_login = function() {
      return $('#login_form').fadeIn();
    };
    UserMenu.prototype.render = function() {
      this.el.hide();
      this.el.html(this.template(app.current_user.toJSON()));
      return this.el.fadeIn("slow");
    };
    UserMenu.prototype.finish_view = function() {
