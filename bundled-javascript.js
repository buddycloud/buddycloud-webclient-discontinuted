...
(function() {
  ...
  SettingsView = (function() {
    ...
    SettingsView.prototype.onSubmit = function() {};
...
<div class="auth">
  ...
  <a class="name" href="#users/<%= @user.escape('jid') %>"><%= @user.escape('jid') %></a>
...
<form action="#settings/save">
  ...
  <div class="f">
    ...
    <input type="text" value="<%= @user.escape('firstName') %>" />
    <small>Your full name and email address is shown to other users in your roster.</small>
  </div>

  <div class="f">
    <label>Last Name</label>
    <input type="text" value="<%= @user.escape('lastName') %>" />
  </div>

  <div class="f">
    <label>Email address</label>
    <input type="text" value="<%= @user.escape('email') %>" />
    <small>
  ...
  <div class="f">
    ...
    <textarea name="description"><%= @user.escape('description') %>"</textarea>
    <small>
...
<h1>
  <img src="/public/icons/emotion_smile.png" />
  Hi <%= @user.getName().capitalize() %> and welcome to Diaspora*x!
</h1>
